...
public class verifyConfirmationMessage {
    ...
    public static void main(String[] args) {
        ...
        /*
        open chrome browser
        go to http://practice.cybertekschool.com/forgot:passwordLinks to an external site.
        enter any email
        ...
        //1.get() --> it will work %99 and it will return string
        //2.getAttribute("value") --> second way of getting text especially input boxes

        String actualEmail = emailInputBox.getAttribute("value");
        System.out.println("actualEmail = "+actualEmail);

        //verify that email is displayedin the input box
